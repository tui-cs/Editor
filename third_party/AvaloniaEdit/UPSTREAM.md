...
| `Document/IDocument.cs` | **Documentation clarification**: expanded `TextChanged` / `ChangeCompleted` XML docs to spell out AvaloniaEdit's inherited per-edit vs completed-update-group event semantics. |
