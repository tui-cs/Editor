...
/examples/
  ted/                            # standalone TG app exercising Editor
  EditorBenchmarks/
...
| 5 | Multi-caret, `LineNumberMargin`, `examples/ted` scenario, tests at coverage parity | 1 week |
...
- `examples/ted` runs and exercises: typing, selection, multi-caret, undo/redo, find/replace, folding, word wrap toggle, line numbers, mouse, large-file load (10 MB file < 200 ms initial render).
