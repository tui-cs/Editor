...
**Status**: Subsumed — shipped as part of [auto-indent](../auto-indent/spec.md) (PR #95). Retained for historical reference only. Per constitution R9 ("lifts must ship with their ted consumer") lift-only specs are no longer scheduled separately.
**Created**: 2026-05-10
