...
// Source taken from: https://github.com/dotnet/runtime/blob/v11.0.100/src/libraries/Common/src/System/Text/ValueStringBuilder_1.cs

#nullable enable

// TODO: this version is only compatible with .NET 11.0 or greater
...
namespace Terminal.Gui.Text.Utils
{
    using System.Text;
        ...
        where TChar : unmanaged
    {
        ...
        public readonly ReadOnlySpan<TChar> AsSpan() => _chars[.._pos];
        public readonly ReadOnlySpan<TChar> AsSpan(int start) => _chars[start.._pos];
