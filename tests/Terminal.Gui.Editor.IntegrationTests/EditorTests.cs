...
public class EditorTests
{
    ...
    [Fact]
    public async Task Enter_Copies_Leading_Whitespace_From_Previous_Line ()
    {
        await using AppFixture<EditorTestHost> fx = new (() => new ("\tab"));
        fx.Top.Editor.SetFocus ();
        fx.Top.Editor.CaretOffset = 3;
    ...
    [Fact]
    public async Task Tab_Inserts_Spaces_When_ConvertTabsToSpaces ()
    {
        await using AppFixture<EditorTestHost> fx = new (() => new ("ab"));
    ...
    public async Task ShiftTab_Unindents_Current_Line ()
    {
        ...
        Assert.Equal ("one", fx.Top.Editor.Document?.Text);
        Assert.Equal (0, fx.Top.Editor.CaretOffset);
    }

    [Fact]
    public async Task Backspace_At_End_Of_Leading_Whitespace_Removes_Indentation_Unit ()
    {
        await using AppFixture<EditorTestHost> fx = new (() => new ("    one"));
        fx.Top.Editor.SetFocus ();
        fx.Top.Editor.CaretOffset = 4;
